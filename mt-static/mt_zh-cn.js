...
Lexicon['Are you sure you want to remove the filter \'[_1]\'?'] = '确定要删除筛选条件\'[_1]\'吗?';
Lexicon['Insert/Edit Link'] = '插入/编辑超链接';
Lexicon['You have unsaved changes to this page that will be lost.'] = '您还没有保存本页面的修改，这些资料将会丢失';
Lexicon['Last auto-save at [_1]:[_2]:[_3]'] = '上一次在[_1]:[_2]:[_3]自动保存';
Lexicon['Tag must have a valid name'] = '标签必须是一个有效的名字';
Lexicon['Source'] = '源码';
Lexicon['Cancel'] = '取消';
Lexicon['configuration directive'] = 'directiva de configuración';
Lexicon['Class Name'] = '类名';
Lexicon['Dimensions'] = '尺寸';
Lexicon['Fullscreen'] = '全屏幕';
Lexicon['Italic (Ctrl+I)'] = '斜体(Ctrl+I)';
Lexicon['A configuration value is required.'] = '必须要有一个设置的值';
Lexicon['Loading...'] = '载入中...';
Lexicon['Auto-saving...'] = '自动保存中...';
Lexicon['delete'] = '删除';
Lexicon['No Preview Available.'] = '没有可用的预览';
Lexicon['You have [quant,_1,registration,registrations] from [_2]'] = '[_2]有[_1]个注册用户';
Lexicon['Enter URL:'] = '输入网址:';
Lexicon['Preview'] = '预览';
Lexicon['The tag \'[_2]\' already exists. Are you sure you want to merge \'[_1]\' with \'[_2]\' across all blogs?'] = '标签\'[_2]\'已存在，确定要在所有博客的范围内将标签\'[_1]\'合并到标签\'[_2]\'吗？';
Lexicon['Select Filter'] = '选择筛选条件';
Lexicon['[_1] - [_2] of [_3]'] = '[_1] - [_2] / [_3]';
Lexicon['Outdent'] = '凸出';
Lexicon['This field must be an integer'] = '此栏位必须是整数';
Lexicon['Insert Image Asset'] = '插入图片资源';
Lexicon['enable'] = '启动';
Lexicon['Passwords do not match.'] = '密码不匹配';
Lexicon['Unlink'] = '取消超链接';
Lexicon['Next'] = '后一篇';
Lexicon['You can only act upon a maximum of [_1] [_2].'] = '最多只能选中[_1]个[_2]。';
Lexicon['[_1] already exists.'] = '[_1]已存在。';
Lexicon['Block Quotation'] = '引用';
Lexicon['Invalid URL'] = 'URL无效';
Lexicon['Indent'] = '缩进';
Lexicon['Label \"[_1]\" is already in use.'] = '标签名\"[_1]\"已经被使用。';
Lexicon['This field is required'] = '项此必须填写';
Lexicon['Des\cription'] = '描述';
Lexicon['remove'] = '删除';
